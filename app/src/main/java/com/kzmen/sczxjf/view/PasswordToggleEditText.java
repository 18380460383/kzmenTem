...
public class PasswordToggleEditText extends EditText implements
    ...
    private void init() {
        ...
        if (mToggleDrawable == null) {
            mToggleDrawable = ContextCompat.getDrawable(getContext(), R.drawable.icon_eye_no_show);
        }
   ...
   /* if(visible){
        mToggleDrawable = ContextCompat.getDrawable(getContext(), R.drawable.icon_eye_show);
    }else{
        mToggleDrawable = ContextCompat.getDrawable(getContext(), R.drawable.icon_eye_no_show);
    }*/
