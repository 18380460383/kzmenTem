...
public class QuitTimer {
    private PlayServiceNew mPlayService;
    ...
    public void init(@NonNull PlayServiceNew playService, @NonNull Handler handler, @NonNull EventCallback<Long> timerCallback) {
