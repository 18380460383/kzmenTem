...
public class AnserQuesActivity extends AppCompatActivity {
    //数据库的名称
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_anser_ques);
        initFile();
        initView();
        initDB();
    }
        ...
        btn_down.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (corrent < count - 1) {
                    ...
                    Log.e("tst", itemBeanList.toString());
                    EToastUtil.show(AnserQuesActivity.this, "" + itemBeanList.size());
                    ...
                    new AlertDialog.Builder(AnserQuesActivity.this).setTitle("提示").setMessage("已经到达最后一道题，是否退出？")
                    ...
                    if (wrongList.size() == 0) {
                        new AlertDialog.Builder(AnserQuesActivity.this).setTitle("提示").setMessage("你好厉害，答对了所有题！")
                                .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                                    @Override
                                    public void onClick(DialogInterface dialog, int which) {
                                        finish();
                    ...
                    //窗口提示
                    new AlertDialog.Builder(AnserQuesActivity.this).setTitle("恭喜，答题完成！")
