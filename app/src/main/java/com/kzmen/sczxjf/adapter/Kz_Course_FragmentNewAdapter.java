...
public class Kz_Course_FragmentNewAdapter extends FragmentStatePagerAdapter {
    private String[] titles;
    private LayoutInflater mInflater;
    private Context mContext;
    private CourseDetailBean bean;

    public Kz_Course_FragmentNewAdapter(FragmentManager fm, Context mContext, String[] titles, CourseDetailBean bean) {
        super(fm);
        this.titles = titles;
